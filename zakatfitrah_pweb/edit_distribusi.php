...
<div class="content">
    ...
    <a href="list_distribusi.php">Kembali</a>
    <div>
        <p>Edit informasi distribusi :</p>
        <table border="1">
            <?php
            $id_distribusi = $_GET['id_distribusi'];
            $data = mysqli_query($con,"select * from tb_distribusi where id_distribusi='$id_distribusi'");
                ...
                ?>
                  <form method="post" action="update_distribusi.php">
                    <table>
                        <tr>
                            <td>Nama</td>
                            <input type="hidden" name="id_distribusi" value="<?php echo $d['id_distribusi']; ?>">
                        ...
                        <tr>
                            <td>Tanggungan</td>
                            <td><input type="text" name="jml_tanggungan" id= "jml12" onchange = "update()" value="<?php echo $d['jml_tanggungan']; ?>">
                        </tr>
                        <tr>
                            <td>Nominal</td>
                            <td><input type="float" name="besar" value="<?php echo $d['besar']; ?>"></td>
                        </tr>
                        <tr>
                            <td>waktu</td>
